...
export const getAdmissions   = (page = 1, limit = 50) => client.get('/admissions', { params: { page, limit } })
...
export const getDischarges   = (page = 1, limit = 50) => client.get('/discharges', { params: { page, limit } })
